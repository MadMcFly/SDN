...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
		...
		#created mininet topology with hosts having the given mac addresses for convinience.
    ...
    def switch_features_handler(self, ev):
        ...
        if dpid == 1: # switch S1
    		...
    		#match=parser.OFPMatch(eth_type=ether.ETH_TYPE_IP,ipv4_src='10.0.0.1',ipv4_dst='10.0.0.3',ip_proto=inet.IPPROTO_TCP)
			#actions = [parser.OFPActionOutput(ofproto.OFPP_CONTROLLER,ofproto.OFPCML_NO_BUFFER)]
	        ...
	        #match1 = parser.OFPMatch(eth_type=ether.ETH_TYPE_IP,ipv4_src='10.0.0.2',ipv4_dst='10.0.0.3',ip_proto=inet.IPPROTO_UDP)
